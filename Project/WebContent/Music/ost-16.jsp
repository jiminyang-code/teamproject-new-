...
<body>
		...
		<div class="pads" style="width: 700px;">
			<div class="pad">
				<img name="igg" onmouseover="chImg(this,'over')"
					...
					<a class="text">음악제목</a>
				<audio id="audio" src="./MusicFile/Animation/YourName/1.mp3"></audio>
			...
			<div class="pad">
				...
				<audio id="audio<%=i%>" src="./MusicFile/Animation/YourName/<%=i%>.mp3"></audio>
	...
	var strArray = ['Nande mo naiya - RADWIMPS',
		'Sparkle - RADWIMPS',
		'Yumetourou - RADWIMPS',
