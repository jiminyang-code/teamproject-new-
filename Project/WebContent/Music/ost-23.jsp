...
<body>
		...
		<div class="pads" style="width: 700px;">
			<div class="pad">
				<img name="igg" onmouseover="chImg(this,'over')"
					...
					<a class="text">음악제목</a>
				<audio id="audio" src="./MusicFile/SF/Real steel/1.mp3"></audio>
			...
			<div class="pad">
				...
				<audio id="audio<%=i%>" src="./MusicFile/SF/Real steel/<%=i%>.mp3"></audio>
	...
	var strArray = ['Fast Lane - Bad Meets Evil',
		'Miss The Misery - Foo Fighters',
		'The Enforcer - 50 Cent',
		'Make Some Noise? - The Crystal Method',
