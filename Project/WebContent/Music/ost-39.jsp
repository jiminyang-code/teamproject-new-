...
<body>
	...
	var strArray = ['Strange Brew - Cream',
		'Goldberg Variations, Air and Variations Nos. 1-30 BMW 988 - Johann Sebastian Bach',
		'Midnight the Stars and You - Jimmy Campbell & Harry M. Woods & Reginald Connelly'];
