...
<%  
		...
		String name = "스파이더맨"; //사진, 음악폴더이름
		String genre = "Action"; //장르폴더명
%>
...
<body>
		...
		<div class="pads" style="width: 700px;">
			<div class="pad">
				<img name="igg" onmouseover="chImg(this,'over')"
					...
					<a class="text">음악제목</a>
				<audio id="audio" src="./MusicFile/<%=genre%>/<%=name %>/1.mp3"></audio>
			...
			<div class="pad">
				...
				<audio id="audio<%=i%>" src="./MusicFile/<%=genre%>/<%=name %>/<%=i%>.mp3"></audio>
	...
	var strArray = ['back in black - AC/DC',
		'Far From Home Suite Home - Michael Giacchino',
		'I Will Always Love You - Whitney Houston',
		'Multiple Realities - Michael Giacchino',
		'Personal Hijinks - Michael Giacchino',
		"'Vacation - The Go-Go's'",
		"'Who's Behind Those Foster Grants - Michael Giacchino'"];
