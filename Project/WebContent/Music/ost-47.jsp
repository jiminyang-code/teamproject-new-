...
<body>
		...
		<div class="pads" style="width: 700px;">
			<div class="pad">
				<img name="igg" onmouseover="chImg(this,'over')"
					...
					<a class="text">음악제목</a>
				<audio id="audio" src="./MusicFile/Animation/IceAge4/1.mp3"></audio>
			...
			<div class="pad">
				...
				<audio id="audio<%=i%>" src="./MusicFile/Animation/IceAge4/<%=i%>.mp3"></audio>
	...
	var strArray = ['CandyMan - Leslie Bricusse & Anthony Newley',
		'Chasing the Sun - The Wanted',
		'Master of the Seas - Peter Dinklage',
		'We Are - Ester Dean'];
