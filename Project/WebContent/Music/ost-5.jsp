...
<body>
		...
		<div class="pads" style="width: 700px;">
			<div class="pad">
				<img name="igg" onmouseover="chImg(this,'over')"
					...
					<a class="text">음악제목</a>
				<audio id="audio" src="./MusicFile/Animation/Frozen1/1.mp3"></audio>
			...
			<div class="pad">
				...
				<audio id="audio<%=i%>" src="./MusicFile/Animation/Frozen1/<%=i%>.mp3"></audio>
	...
	<script>
		...
		var strArray = ["Vuelie - Frode Fjellheim & Christophe Beck","Love Is an Open Door - Kristen Bell & Santino Fontana", "For the First Time in Forever - Kristen Bell & Idina Menzel",'Let It Go - Idina Menzel'
