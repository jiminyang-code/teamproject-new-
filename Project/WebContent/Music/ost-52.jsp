...
<%  
		...
		String name = "The Avengers"; //사진, 음악폴더이름
...
<body>
	...
	var strArray = ["'String Quartet No. 13 in a Minor 'Rosamunde' D'804 - Franz Schubert'",
		'Shoot to Thrill - Angus Young & Malcolm Young & Brian Johnson',
