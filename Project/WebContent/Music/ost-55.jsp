...
<%  
		...
		String name = "InfinityWar"; //사진, 음악폴더이름
%>
...
<body>
	...
	<div class="image">
		<img alt="" src="./image/<%=name %>.jpg" style="width: 500px;">
	</div>
		...
		<div class="pads" style="width: 700px;">
			<div class="pad">
				<img name="igg" onmouseover="chImg(this,'over')"
					...
					<a class="text">음악제목</a>
				<audio id="audio" src="./MusicFile/SF/<%=name %>/1.mp3"></audio>
			...
			<div class="pad">
				...
				<audio id="audio<%=i%>" src="./MusicFile/SF/<%=name %>/<%=i%>.mp3"></audio>
	...
	var strArray = ['Travel Delays - Alan Silvestri',
		'Undying Fidelity - Alan Silvestri',
		"'He Won't Come Out - Alan Silvestri'",
		'We Both Made Promises - Alan Silvestri',
		'Help Arrives - Alan Silvestri',
		'Hand Means Stop - Alan Silvestri',
		'You Go Right - Alan Silvestri',
		'Family Affairs - Alan Silvestri',
];
