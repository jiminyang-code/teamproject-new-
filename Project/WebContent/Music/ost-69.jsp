...
<body>
		...
		<div class="pads" style="width: 700px;">
			<div class="pad">
				<img name="igg" onmouseover="chImg(this,'over')"
					...
					<a class="text">음악제목</a>
				<audio id="audio" src="./MusicFile/Animation/Zootopia/1.mp3"></audio>
			...
			<div class="pad">
				...
				<audio id="audio<%=i%>" src="./MusicFile/Animation/Zootopia/<%=i%>.mp3"></audio>
	...
	var strArray = ['All By Myself - Eric Carmen & Sergei Rachmaninoff',
		"'Can't Do Nuthin' Right - Madisen Ward",
		'Everybody Hurts - R.E.M',
		'Give Me A Try - Andrea Datzman',
		'One More Time - Barrie Gledden',
