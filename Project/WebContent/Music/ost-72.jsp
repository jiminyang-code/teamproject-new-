...
<%  
		...
		String name = "Conjuring"; //사진, 음악폴더이름
		String genre = "Thriller"; //장르폴더명
%>
...
<body>
	...
	var strArray = ["'In The Room Where You Sleep - Dead Man's Bones'",
		'Sleep Walk - Santo & Johnny Farina',
		'So Cold - Benjamin Burnley',
		'Time of the Season - Rod Argent & Colin Blunstone',
