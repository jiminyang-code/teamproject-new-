...
<body>
		...
		<div class="pads" style="width: 700px;">
			<div class="pad">
				<img name="igg" onmouseover="chImg(this,'over')"
					...
					<a class="text">음악제목</a>
				<audio id="audio" src="./MusicFile/Animation/<%=name %>/1.mp3"></audio>
			...
			<div class="pad">
				...
				<audio id="audio<%=i%>" src="./MusicFile/Animation/<%=name %>/<%=i%>.mp3"></audio>
	...
	var strArray = ['Everyone Knows Juanita - Germaine Franco',
		'Jalale - Mexican Institute Of Sound',
		'La Llorona - Alanna Ubach & Antonio Sol',
		'Much Needed Advice - Antonio Sol & Benjamin Bratt',
		'Proud Corazón - Germaine Franco',
